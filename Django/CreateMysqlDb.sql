...
CREATE TABLE `ring`.`ringdata` (
  ...
  `order1amount` VARCHAR(45) NULL,
  `order1nextamount` VARCHAR(45) NULL,
  ...
  `order2amount` VARCHAR(45) NULL,
  `order2nextamount` VARCHAR(45) NULL,
  ...
  `order3amount` VARCHAR(45) NULL,
  `order3nextamount` VARCHAR(45) NULL,
